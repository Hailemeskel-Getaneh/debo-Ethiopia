                ...
                <div className="p-4 border-t border-zinc-100 dark:border-zinc-800/50 bg-zinc-50/50 dark:bg-zinc-900/50 backdrop-blur-sm">
                    <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-white dark:hover:bg-zinc-800 border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700 transition-all shadow-sm hover:shadow-md cursor-pointer group">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate group-hover:text-[--color-primary-600] dark:group-hover:text-[--color-primary-400] transition-colors">
                                Admin User
                            </p>
                ...
                <header className="h-20 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-800/50 sticky top-0 z-40 px-8 flex items-center justify-between transition-all">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative hidden md:block group">
                            <Search className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-[--color-primary-500] transition-colors" />
                            <input
                                type="text"
                                placeholder="Search anything..."
                                className="w-72 pl-10 pr-4 py-2.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[--color-primary-500]/20 focus:border-[--color-primary-500] transition-all shadow-sm"
                            />
                        </div>
                        ...
                        {/* Notifications */}
                        <button className="relative p-2.5 text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl transition-all hover:text-[--color-primary-600] active:scale-95">
