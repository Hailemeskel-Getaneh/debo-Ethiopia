...
import { Heart, ArrowRight, BookOpen, Stethoscope, Sprout, Users, ChevronDown, Target, Leaf, GraduationCap, Users2 } from "lucide-react";
...
const news = [
  {
    ...
    excerpt: "A state-of-the-art learning center serving 500 students opens its doors to the community.",
    category: "Education",
  },
  {
    date: "Dec 28, 2025",
    title: "Annual Impact Report 2025: 12,000 New Beneficiaries",
    excerpt: "Our 2025 annual report highlights remarkable growth and community transformation across all programs.",
    category: "Impact",
  },
  {
    date: "Dec 10, 2025",
    title: "Partnership with UN FAO to Expand Agricultural Programs",
    excerpt: "A landmark partnership will triple our agricultural support to smallholder farmers in southern Ethiopia.",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="Ethiopian community" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="font-body text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
              Debo Ethiopia works alongside communities to create lasting change through education, health, agriculture, and sustainable development programs.
            </p>
          ...
          >
            {stats.map(({ value, label }) => (
              <motion.div key={label} variants={fadeUp} className="text-center">
                <div className="font-display text-4xl md:text-5xl font-bold text-white mb-1">{value}</div>
                <div className="font-body text-sm text-white/70 uppercase tracking-wider">{label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
                The Spirit of <span className="text-brand-main">Collective Action</span>
              </h2>
              <p className="font-body text-muted-foreground leading-relaxed mb-4">
                Established in 2005, Debo Ethiopia is a non-profit, non-governmental organization (NGO) dedicated to improving the quality of life for communities in rural Ethiopia through holistic and sustainable development.
              </p>
              <p className="font-body text-muted-foreground leading-relaxed mb-8">
                We deliver essential services that address the root causes of poverty and inequality, guided by the ancient Ethiopian tradition of "Debo" — communal cooperation for the greater good.
              </p>
              <Link to="/about">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 bg-linear-to-br from-brand-main to-primary-700 p-8 rounded-3xl shadow-xl shadow-primary-700/20 hidden lg:block hover:scale-105 transition-transform">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-white font-display text-2xl font-bold">Impact First</p>
                </div>
                <p className="text-white/80 text-sm">Community-led development</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-zinc-50 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              We operate with a community-centered participatory model. By respecting local knowledge and priorities, we ensure local people are actively involved in identifying challenges and planning solutions.
            </motion.p>
          </div>
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="font-display text-xl font-bold text-zinc-900 mb-3">{item.title}</h3>
                <p className="font-body text-sm text-zinc-600 leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-20 section-gradient">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">Our Core Programs</h2>
            <p className="font-body text-muted-foreground max-w-xl mx-auto">
              Four pillars of community transformation designed for lasting, measurable impact.
            </p>
          </motion.div>
          <motion.div
            initial="hidden"
            ...
            {programs.map(({ icon: Icon, title, desc, color, href }) => (
              <motion.div key={title} variants={fadeUp}>
                ...
                >
                  ...
                  <h3 className="font-display text-lg font-semibold text-zinc-900 mb-2">{title}</h3>
                  <p className="font-body text-sm text-zinc-600 leading-relaxed flex-1">{desc}</p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-14"
          >
            <span className="inline-block text-xs font-body font-semibold text-brand-action uppercase tracking-widest mb-3">Active Work</span>
            ...
            {projects.map(({ title, category, status, progress, location }) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`text-xs font-body font-medium ${status === "Completed" ? "text-brand-action" : "text-brand-secondary"}`}>
                    ● {status}
                  </span>
                </div>
                <h3 className="font-display font-semibold text-zinc-900 mb-1">{title}</h3>
                <p className="font-body text-xs text-zinc-500 mb-4">{location}</p>
                ...
                <p className="font-body text-xs text-zinc-500 text-right">{progress}% Complete</p>
              </motion.div>
            ))}
          </motion.div>
          <div className="text-center mt-10">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="font-body text-white/80 text-lg max-w-xl mx-auto mb-10">
              Every birr, every dollar, every act of generosity creates real change for Ethiopian families.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          >
            <div>
              <span className="inline-block text-xs font-body font-semibold text-brand-action uppercase tracking-widest mb-2">Stay Informed</span>
              <h2 className="font-display text-4xl font-bold text-foreground">Latest News</h2>
            </div>
            <Link to="/news" className="mt-4 sm:mt-0">
              <Button variant="outline" className="border-primary text-primary font-body gap-2">
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="px-2 py-0.5 rounded-full text-xs bg-brand-action/10 text-brand-action font-body font-medium">{category}</span>
                    <span className="text-xs text-zinc-500 font-body">{date}</span>
                  </div>
                  <h3 className="font-display font-semibold text-zinc-900 mb-2 leading-snug group-hover:text-brand-main transition-colors">
                    {title}
                  </h3>
                  <p className="font-body text-sm text-zinc-600 leading-relaxed">{excerpt}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
