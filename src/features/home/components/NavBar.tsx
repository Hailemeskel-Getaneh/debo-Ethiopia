      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="relative z-50 flex items-center gap-2 group">
            <div className="w-20 h-10 rounded-md bg-white flex items-center justify-center shadow-sm  border-gray-100 group-hover:scale-105 transition-transform overflow-hidden">
              <img
                src={logo}
                alt="Debo Logo"
          ...
          <div className="hidden lg:flex items-center gap-2">
            {navLinks.map((link) => (
              ...
              >
                {link.dropdown ? (
                  <button
                    className={`flex items-center gap-1 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${isScrolled
                  ...
                  <Link
                    to={link.href}
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${isScrolled
                      ? "text-gray-700 hover:text-[#16A34A] hover:bg-gray-50"
                      : "text-gray-800 hover:text-[#16A34A] hover:bg-gray-50"
                      }`}
                  >
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link to="/donate">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-rose-600 hover:bg-rose-700 text-white px-6 py-2.5 rounded-md text-sm font-semibold flex items-center gap-2 shadow-sm hover:shadow-md transition-all duration-200"
              >
          ...
          <button
            ...
            className={`lg:hidden relative z-50 p-2 rounded-md transition-all ${mobileMenuOpen
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-auto py-10 flex flex-col gap-4">
              <Link
                to="/donate"
                className="bg-rose-600 hover:bg-rose-700 text-white w-full py-4 rounded-xl text-center font-bold text-lg flex items-center justify-center gap-2 transition-all duration-200"
              >
