...
const programs = [
  {
    ...
    sites: "20 schools",
    status: "Active",
    image: "/src/assets/images/IMG_20231104_083345.jpg",
  ...
  },
  {
    ...
    sites: "18 schools",
    status: "Active",
    image: "/src/assets/images/6-1.jpg",
  ...
  },
  {
    ...
    sites: "15 schools",
    status: "Annual",
    image: "/src/assets/images/doc.jpg",
...
export function HealthProgram() {
  ...
  const heroImages = [
    "/src/assets/images/IMG_20231206_144403.jpg",
    "/src/assets/images/IMG_20231210_135056.jpg",
    "/src/assets/images/IMG_20231104_083345.jpg",
  ];
        ...
        <section className="relative min-h-[60vh] flex items-center overflow-hidden pt-20">
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            <p className="text-xl text-white/75 max-w-xl mb-10">
              A child who is well-fed, healthy, and emotionally supported learns
              better. Our health programs address the full spectrum of child
              wellbeing.
            </p>
            <a
              href="/donate"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
              {[
                ...
                <div key={i} className="py-10 text-center">
                  <p className="text-4xl font-black text-[#DA121A]">
                    {s.value}
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-500 max-w-xl mx-auto">
                Four targeted programs addressing nutrition, mental health,
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500">
                Evidence-based results from our community health work.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  ...
                  desc: "Community empowerment, orphan support, and youth skills.",
                },
              ].map((link, i) => (
                <a
                  key={i}
        ...
        <section className="py-20 bg-gradient-to-br from-[#5a0000] to-[#DA121A] text-white">
          <div className="max-w-3xl mx-auto px-4 text-center">
            <h2 className="text-4xl font-extrabold mb-4">
              Help a Child Stay Healthy
            </h2>
            <p className="text-white/75 text-lg mb-8">
              Your donation funds meals, clean water, and health screenings for
