...
export function EducationProgram() {
    ...
    const heroImages = [
        ...
        "https://images.unsplash.com/photo-1577896851231-70ef18881754?w=1400&fit=crop",
            ...
            <main id="main-content">
                ...
                <section className="relative min-h-[60vh] flex items-center overflow-hidden pt-20">
                    ...
                    <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                        ...
                        <p className="text-xl text-white/75 max-w-xl mb-10">
                            We believe every child in Ethiopia deserves access to quality education.
                            Our programs break down barriers and open doors to lasting opportunity.
                        </p>
                        <a
                            href="/donate"
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
                            {[
                                ...
                                <div key={i} className="py-10 text-center">
                                    <p className="text-4xl font-black text-[#009639]">{s.value}</p>
                ...
                <section className="py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Education Initiatives</h2>
                            <p className="text-lg text-gray-500 max-w-xl mx-auto">
                                Four focused programs designed to reach every learner, from primary
                                school through teacher development.
                            </p>
                        </div>
                        ...
                        <div className="space-y-10">
                            {programs.map((prog, i) => (
                                <div
                                    key={i}
                                    className={`flex flex-col lg:flex-row gap-8 items-center bg-gray-50 rounded-3xl overflow-hidden hover:shadow-lg transition-shadow duration-300 ${i % 2 !== 0 ? "lg:flex-row-reverse" : ""
                                        }`}
                                >
                                    ...
                                    <div className="p-8 flex-1">
                                        ...
                                        <p className="text-gray-500 mb-6 leading-relaxed">{prog.description}</p>
                ...
                <section className="py-20 bg-emerald-50">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-extrabold text-gray-900 mb-3">Our Impact at a Glance</h2>
                            <p className="text-gray-500">Measured, real, and transformative results.</p>
                        </div>
                ...
                <section className="py-16 bg-white border-t">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid sm:grid-cols-2 gap-5">
                            {[
                                { href: "/programs?type=health", label: "Health Programs", desc: "School nutrition, clean water, and mental health." },
                                { href: "/programs?type=social", label: "Social Support Programs", desc: "Community empowerment and youth skills." },
                            ].map((link, i) => (
                                <a
                                    key={i}
                                    href={link.href}
                ...
                <section className="py-20 bg-gradient-to-br from-[#003d1a] to-[#009639] text-white">
                    <div className="max-w-3xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-extrabold mb-4">Help a Child Learn Today</h2>
                        <p className="text-white/75 text-lg mb-8">
                            Every dollar you give goes directly into books, teachers, and technology for Ethiopian children.
                        </p>
                        <a
                            href="/donate"
