            ...
            <main id="main-content">
                ...
                <section className="relative min-h-[52vh] flex items-center overflow-hidden pt-20">
                    ...
                    <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center w-full">
                        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white/80 text-sm px-4 py-2 rounded-full mb-6">
                            <Sparkles className="w-4 h-4 text-[#FCDD09]" /> Changing Lives Across Ethiopia
                        </div>
                        ...
                        <p className="text-xl text-white/75 max-w-2xl mx-auto mb-10">
                            From education to health to social empowerment — explore the programs that are
                            transforming communities across Ethiopia.
                        </p>
                                ...
                                {filtered.map((program) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative h-48 overflow-hidden">
                                            ...
                                            {program.badge && (
                                                <span className={`absolute top-4 left-4 bg-gradient-to-r ${program.color} text-white text-xs font-bold px-3 py-1 rounded-full shadow`}>
                                                    {program.badge}
                                                </span>
                                            )}
                                            {/* Category chip */}
                                        ...
                                        <div className="p-6 flex flex-col flex-1">
                                            ...
                                            <p className="text-sm text-gray-500 leading-relaxed flex-1">{program.description}</p>

                                            {/* Meta */}
                                            <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-100">
                                                <div className="text-center">
                                                    <p className="text-sm font-bold text-[#009639]">{program.participants}</p>
                                                    <p className="text-xs text-gray-400">Participants</p>
                                                </div>
                                                <div className="text-center">
                                                    <p className="text-sm font-bold text-[#009639]">{program.schools}</p>
                ...
                <section className="py-20 bg-gradient-to-br from-[#003d1a] to-[#009639] text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-extrabold mb-4">Want to Support a Program?</h2>
                        <p className="text-xl text-white/75 mb-8">
                            Your donation directly funds these programs and changes children's lives.
                        </p>
                        <a
                            href="/donate"
