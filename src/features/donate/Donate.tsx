...
const tiers = [
  {
    ...
    icon: Heart,
    perks: ["Impact newsletter", "Digital thank-you card"],
  },
  {
    label: "Supporter",
    min: 50,
  ...
  },
  {
    ...
    min: 1000,
    max: Infinity,
    color: "from-[#DA121A] to-rose-700",
    icon: Sparkles,
    perks: [
      "All Champion perks",
      "Name on our website",
      "Direct call with our Executive Director",
    ],
  },
];
...
const impactStats = [
  ...
  { icon: Users, value: "$100", label: "pays a girl's school fees for a term" },
  {
    icon: Home,
    value: "$500",
    label: "sponsors one full semester scholarship",
  },
];
...
export function Donate() {
  ...
  const impactText =
    impactMap[selectedAmount] ??
    (effectiveAmount >= 500 ? impactMap[500] : impactMap[10]);
    ...
    <div className="min-h-screen bg-white">
      ...
      <main id="main-content">
        ...
        <section className="relative min-h-[45vh] flex items-center overflow-hidden pt-20">
          ...
          />
          <div className="absolute -top-24 -right-24 w-[450px] h-[450px] rounded-full bg-[#16A34A]/10 blur-3xl" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center w-full">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white/80 text-sm px-4 py-2 rounded-full mb-6">
              <Heart className="w-4 h-4 text-[#16A34A]" /> Every Donation Counts
            </div>
            ...
            <p className="text-xl text-white/75 max-w-2xl mx-auto">
              Your donation directly funds education, health, and community
              programs for Ethiopia's most vulnerable children. 100% goes to the
              mission.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
              {impactStats.map((s, i) => (
                <div
                  key={i}
                  className="py-8 flex flex-col items-center gap-2 text-center px-4"
                >
            ...
            <div className="grid lg:grid-cols-5 gap-12">
                ...
                {submitted ? (
                  <div className="bg-white border border-gray-100 rounded-3xl p-12 shadow-xl text-center">
                    ...
                    <p className="text-lg text-gray-500 mb-6">
                      ...
                      has been received. You'll get a receipt at{" "}
                      <span className="font-semibold">{form.email}</span>.
                    </p>
                    {currentTier && (
                      <div
                        className={`inline-flex items-center gap-2 bg-gradient-to-r ${currentTier.color} text-white font-bold px-5 py-2.5 rounded-full mb-6`}
                      >
                        <currentTier.icon className="w-4 h-4" />{" "}
                        {currentTier.label} Donor
                      </div>
                    )}
                    <p className="text-sm text-gray-400">
                      Together, we're building Ethiopia's future — one child at
                      a time. 🇪🇹
                    </p>
                  </div>
                ) : (
                      ...
                      {step === 1 && (
                        <div className="space-y-7">
                          ...
                          <div>
                            ...
                            {frequency === "monthly" && (
                              <p className="text-xs text-emerald-600 font-medium mt-2 flex items-center gap-1">
                                <CheckCircle2 className="w-3.5 h-3.5" /> Monthly
                                donors create lasting, predictable impact
                              </p>
                            )}
                          </div>
                          ...
                          {currentTier && effectiveAmount > 0 && (
                            <div
                              className={`flex items-center gap-3 bg-gradient-to-r ${currentTier.color} text-white rounded-2xl p-4`}
                            >
                          ...
                          {paymentMethod === "card" ? (
                            ...
                            <div>
                              ...
                              <p className="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                ...
                                Have your phone ready to confirm the USSD
                                prompt.
                              </p>
                            </div>
                          ) : (
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="space-y-3">
                    {tiers.map((tier, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`flex items-center gap-3 p-3.5 rounded-xl bg-gradient-to-r ${tier.color} text-white`}
                        >
                ...
                <div className="bg-[#003d1a] rounded-2xl p-6 text-white">
                  ...
                  <a
                    href="/contact"
                    className="inline-flex items-center gap-1.5 mt-4 text-[#16A34A] font-semibold text-sm hover:underline"
                  >
