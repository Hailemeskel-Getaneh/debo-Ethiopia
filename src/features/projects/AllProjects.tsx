...
> = {
  active: { icon: PlayCircle, color: "text-[#009639]", bg: "bg-[#009639]/10" },
  completed: {
    icon: CheckCircle2,
    color: "text-[#009639]",
    bg: "bg-[#009639]/10",
  },
  upcoming: { icon: Clock, color: "text-[#009639]", bg: "bg-[#009639]/10" },
};
      ...
      <main id="main-content">
        ...
        <section className="relative min-h-[52vh] flex items-center overflow-hidden pt-20">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(https://images.unsplash.com/photo-1497366216548-37526070297c?w=1400&fit=crop)",
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          />
          <div className="absolute inset-0 bg-gradient-to-br from-[#003d1a]/90 to-[#009639]/60" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center w-full">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white/80 text-sm px-4 py-2 rounded-full mb-6">
              <Sparkles className="w-4 h-4 text-[#00b359]" /> Projects Across
              Ethiopia
            </div>
            ...
            <p className="text-xl text-white/75 max-w-2xl mx-auto mb-10">
              From school libraries to clean water systems — discover the
              on-the-ground projects that are transforming communities across
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        {/* Status badge */}
                        <span
                          className={`absolute top-4 left-4 inline-flex items-center gap-1.5 ${M.bg} ${M.color} text-xs font-bold px-3 py-1.5 rounded-full shadow`}
                        >
        ...
        <section className="py-20 bg-gradient-to-br from-[#003d1a] to-[#009639] text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/75 mb-8">
              Your donation directly enables the next school library, water
              borehole, or scholarship.
            </p>
            <a
              href="/donate"
