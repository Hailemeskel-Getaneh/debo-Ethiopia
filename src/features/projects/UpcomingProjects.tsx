...
const upcomingProjects = [
  {
    ...
    description:
      "Installing solar power systems in 8 off-grid schools to enable evening study sessions, power computers, and provide reliable electricity to rural communities.",
    location: "Bahir Dar",
    region: "Amhara",
    startDate: "Jul 2025",
    endDate: "Dec 2025",
    ...
    image:
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&h=480&fit=crop",
    goals: [
      "Install solar panels in 8 schools",
      "Power 30 computers per school",
      "Enable 4-hour evening study sessions",
  ...
  },
  {
    ...
    description:
      "Launching Ethiopia's first school-based mental health pilot program with trained counselors, peer-support networks, and teacher mental health training in 5 urban schools.",
    location: "Harar",
    region: "Harari",
    startDate: "Aug 2025",
    endDate: "Jul 2026",
    ...
    image:
      "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=700&h=480&fit=crop",
    goals: [
      "Train 20 school counselors",
      "Establish peer-support groups in 5 schools",
      "Provide teacher mental health workshops",
      "Create referral pathways to community services",
    ],
  },
  {
    title: "Arba Minch Safe Housing Initiative",
    description:
      "Partnering with local communities to build or rehabilitate 50 safe, durable homes for families living in extreme poverty in Arba Minch district.",
    location: "Arba Minch",
    region: "SNNPR",
    startDate: "Oct 2025",
    endDate: "Sep 2026",
    ...
    impact: "50 families",
    image:
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=700&h=480&fit=crop",
    goals: [
      "Construct or rehabilitate 50 homes",
      "Engage community members as builders",
      "Provide ownership deeds to families",
      "Install basic sanitation in each home",
    ],
  },
];
        ...
        <section className="relative min-h-[52vh] flex items-center overflow-hidden pt-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            ...
            <p className="text-xl text-white/75 max-w-xl">
              These projects are funded and ready to launch. Your support today
              ensures they start on schedule.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
              {[
                { value: "3", label: "Upcoming Projects" },
                { value: "3,950+", label: "Future Beneficiaries" },
                { value: "$217,000", label: "Budget Needed" },
                { value: "$25,000", label: "Raised So Far" },
              ].map((s, i) => (
                ...
                >
                  ...
                  <div className="flex-1 p-8 lg:p-10">
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      <span className="bg-[#009639]/10 text-[#009639] text-xs font-medium px-3 py-1.5 rounded-full">
                        {project.impact} will benefit
                      </span>
                    </div>
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between text-sm mb-2">
                        ...
                        <span className="font-bold text-[#009639]">
                          {project.progress}% of {project.budget}
                        </span>
                      </div>
                    ...
                    <div className="bg-[#009639]/5 rounded-2xl p-5 mb-6">
                      <p className="text-xs font-bold text-[#009639] uppercase tracking-widest mb-3 flex items-center gap-1.5">
                      ...
                      <ul className="space-y-2">
                        {project.goals.map((g, j) => (
                          ...
                          >
                            <ChevronRight className="w-4 h-4 text-[#009639] mt-0.5 flex-shrink-0" />{" "}
                            {g}
                          </li>
                        ))}
                      </ul>
        ...
        <section className="py-20 bg-gradient-to-br from-[#003d1a] to-[#009639] text-white">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-white/75 text-lg mb-8">
              Be among the first to fund these projects and make them a reality
