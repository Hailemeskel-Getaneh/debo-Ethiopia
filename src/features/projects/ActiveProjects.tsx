        ...
        <section className="relative min-h-[52vh] flex items-center overflow-hidden pt-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            ...
            <p className="text-xl text-white/75 max-w-xl">
              These projects are live and in full swing. Every donation made
              today directly accelerates their progress.
            </p>
          </div>
        </section>
                  ...
                  <div className="flex-1 p-8 lg:p-10">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-[#009639] to-[#00b359] rounded-full"
        ...
        <section className="py-20 bg-gradient-to-br from-[#003d1a] to-[#009639] text-white">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-white/75 text-lg mb-8">
              Additional funding helps us reach our goals faster and start the
              next project sooner.
            </p>
            <a
              href="/donate"
