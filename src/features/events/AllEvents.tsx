...
const events = [
    {
        ...
        category: "Gala",
        description: "Our flagship annual fundraising gala celebrating education heroes and raising funds for the next year's scholarships and programs.",
        date: "Jun 14, 2025",
    ...
    },
    {
        ...
        category: "Community",
        description: "Open registration day for our 3-week summer STEM camp for students aged 10–17. Meet mentors, tour the facilities, and sign up your child.",
        date: "May 10, 2025",
    ...
    },
    {
        ...
        category: "Workshop",
        description: "A one-day interactive workshop empowering girls aged 13–18 with coding, design, and tech entrepreneurship skills led by women in tech.",
        date: "May 24, 2025",
    ...
    },
    {
        ...
        category: "Conference",
        description: "A multi-stakeholder conference bringing together policymakers, educators, and NGOs to discuss the future of education in Ethiopia.",
        date: "Jul 8, 2025",
    ...
    },
    {
        ...
        category: "Ceremony",
        description: "Celebrated 50 scholarship recipients from the Gondar Girls' Initiative with their families, mentors, and school principals.",
        date: "Dec 12, 2024",
    ...
    },
    {
        ...
        category: "Community",
        description: "Free health screenings, nutrition workshops, and hygiene education for 2,000+ community members across 3 neighborhoods in Hawassa.",
        date: "Nov 5, 2024",
    ...
    },
    {
        ...
        category: "Workshop",
        description: "48-hour hackathon where 80 teachers co-designed new classroom teaching tools and digital lesson plans now used in 15 schools.",
        date: "Oct 18, 2024",
        time: "9:00 AM (2 days)",
        ...
        <div className="min-h-screen bg-white">
            ...
            <main id="main-content">
                ...
                <section className="relative min-h-[52vh] flex items-center overflow-hidden pt-20">
                    ...
                    <div className="absolute bottom-20 -left-20 w-72 h-72 rounded-full bg-[#FCDD09]/10 blur-3xl" />
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center w-full">
                        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white/80 text-sm px-4 py-2 rounded-full mb-6">
                            <Sparkles className="w-4 h-4 text-[#FCDD09]" /> Events & Gatherings
                        </div>
                        ...
                        <p className="text-xl text-white/75 max-w-2xl mx-auto mb-10">
                            From fundraising galas to community workshops — join us at events that inspire,
                            connect, and drive change across Ethiopia.
                        </p>
                ...
                <section className="bg-white border-b">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
                            {[
                                { value: `${events.filter(e => e.type === "upcoming").length}`, label: "Upcoming Events" },
                                { value: `${events.filter(e => e.type === "past").length}`, label: "Past Events" },
                ...
                <section className="py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-wrap gap-3 mb-10">
                            {filters.map((f) => (
                                <button
                                    ...
                                    className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 ${activeFilter === f.id
                        ...
                        <p className="text-sm text-gray-400 mb-8">Showing {filtered.length} event{filtered.length !== 1 ? "s" : ""}</p>
                                    ...
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            ...
                                            <div className="absolute top-4 left-4 bg-white rounded-xl p-2 text-center shadow-md min-w-[48px]">
                                                <p className="text-xs font-bold text-purple-700 uppercase leading-tight">{event.date.split(" ")[0]}</p>
                                                <p className="text-xl font-black text-gray-900 leading-tight">{event.date.split(" ")[1].replace(",", "")}</p>
                                            </div>
                                            {/* Type badge */}
                                            ...
                                            {event.type === "past" && (
                                                <span className="absolute bottom-4 left-4 bg-black/60 text-white text-xs font-bold px-3 py-1 rounded-full">Past Event</span>
                                            )}
                                        </div>

                                        <div className="p-6 flex flex-col flex-1">
                                            <h3 className="text-lg font-bold text-gray-900 mb-2">{event.title}</h3>
                                            <p className="text-sm text-gray-500 leading-relaxed flex-1 mb-4">{event.description}</p>

                                            <div className="space-y-1.5 mb-4 text-xs text-gray-400">
                                                <span className="flex items-center gap-2"><Clock className="w-3.5 h-3.5" /> {event.date} · {event.time}</span>
                                                <span className="flex items-center gap-2"><MapPin className="w-3.5 h-3.5" /> {event.location}</span>
                                                <span className="flex items-center gap-2"><Users className="w-3.5 h-3.5" />
                                                    {event.type === "upcoming" ? `${event.seatsLeft} seats remaining` : `${event.seats} attended`}
                                                </span>
                                            </div>
                                            ...
                                            {event.registration ? (
                                                <a
                                                    href="/contact"
                                                    className="inline-flex items-center justify-center gap-1.5 bg-purple-700 text-white font-semibold text-sm py-2.5 rounded-xl hover:bg-purple-800 transition-colors"
                                                >
                ...
                <section className="py-20 bg-gradient-to-br from-[#1a0030] to-[#5c00a8] text-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <h2 className="text-4xl font-extrabold mb-4">Want to Partner on an Event?</h2>
                        <p className="text-xl text-white/75 mb-8">We welcome sponsors, volunteers, and community partners who want to help make our events impactful.</p>
                        <a href="/contact" className="inline-flex items-center gap-2 bg-[#FCDD09] text-black font-bold px-8 py-4 rounded-full hover:scale-105 hover:shadow-2xl transition-all duration-300">
