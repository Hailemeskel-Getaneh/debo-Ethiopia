                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 mt-1">
                                                <a href="tel:+251911234567" className="hover:text-[#009639] transition-colors">+251 911 234 567</a><br />
                                                <a href="tel:+251116123456" className="hover:text-[#009639] transition-colors">+251 116 123 456</a>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 mt-1">
                                                <a href="mailto:info@deboethiopia.org" className="hover:text-[#009639] transition-colors">info@deboethiopia.org</a><br />
                                                <a href="mailto:support@deboethiopia.org" className="hover:text-[#009639] transition-colors">support@deboethiopia.org</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {submitted ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-600 mb-8">
                                        Thank you for reaching out, {form.name.split(' ')[0] || "friend"}. We'll get back to you at <strong>{form.email}</strong> as soon as possible.
                                    </p>
                                    <button
