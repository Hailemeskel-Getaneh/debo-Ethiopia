  ...
  const handleSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (modalMode === "Add") await programsService.create(payload);
        ...
        await programsService.update(selectedProgram.id, payload);
    ...
    <div className="space-y-6">
      ...
      {error && (
        <div className="flex items-center gap-3 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 rounded-xl text-red-700 dark:text-red-300">
          ...
          <button onClick={fetchPrograms} className="ml-auto text-xs underline">
            Retry
          </button>
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {programs.length === 0 && (
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border p-12 text-center text-zinc-400">
              No programs found.
            </div>
          )}
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 text-zinc-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                  >
              ...
              <form className="p-8 space-y-4" onSubmit={handleSave}>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    placeholder="e.g. Literacy Support"
