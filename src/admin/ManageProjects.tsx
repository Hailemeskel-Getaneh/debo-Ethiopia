              ...
              {loading ? (
                ...
                projects.map((project, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-2.5 py-1 inline-flex text-xs font-semibold rounded-full border ${statusStyles[project.status]}`}
                      >
                        {project.status}
                      </span>
                    </td>
        ...
        <div className="px-6 py-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page <= 1}
              className="px-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors disabled:opacity-40"
            >
              Previous
            </button>
            <button
              ...
              className="px-4 py-2 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 rounded-lg text-sm hover:bg-zinc-800 transition-colors disabled:opacity-40"
            >
              Next
            </button>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-500">
                      Define project goals and resources.
                    </p>
                  </div>
                </div>
                <button
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-xl bg-orange-600 text-white font-bold hover:bg-orange-700 shadow-lg shadow-orange-500/20 transition-all"
                >
                  Confirm Delete
                </button>
              </div>
